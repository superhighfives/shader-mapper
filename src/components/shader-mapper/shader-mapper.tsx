...
export class Mapper {
  ...
  @Listen("turbulenceStart", { target: "window" })
  turbulenceStartHandler() {
    this.uMovement && this.uMovement.set(this.uMovement.state + 1);
  }
  ...
  createScene() {
    ...
    this.uMovement = new EasingUniform(
      "u_movement",
      "1f",
      this.program,
      this.context
  ...
  setSizes() {
    ...
    this.uThreshold.set(window.scrollX, window.scrollY);
    this.uMovement.set(0);
