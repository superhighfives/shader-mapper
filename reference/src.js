...
export default class Sketch {
  constructor() {
    ...
    this.imageOriginal = require('./images/scene.jpg')
    this.imageDepth = require('./images/scene-map.jpg')
    this.vth = 50
    this.hth = 50
  ...
  resizeHandler() {
    ...
    //  a2 = 1
    //}
    this.uResolution.set(this.width, this.height, 1, 1)
